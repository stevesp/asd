...
public class StrutturaCollegata implements Dizionario {
	...
	/*
	 * Contemplare i seguenti casi: 1. Il dizionario è vuoto: list == null.
	 * Solleva l'eccezione. 2. La chiave non è presente nel dizionario. Solleva
	 * l'eccezione. 3. L'elemento cercato è presente ed è l'unico della lista.
	 * Poni list a null. 4. L'elemento cercato è presente ed è il primo della
	 * lista. Aggiorna list. 5. L'elemento cercato è presente ed è successivo al
	 * primo. Aggiorna i puntatori del predecessore e del successore.
	 */
	@Override
