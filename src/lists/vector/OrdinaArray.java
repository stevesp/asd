...
public class OrdinaArray {
	...
	public static void main(String[] args) {
		Integer maxDim, step;
		Integer nroConfrontiBS = new Integer(0), nroConfrontiCrescenteBS = new Integer(0), nroConfrontiDecrescenteBS = new Integer(0);
		Integer nroConfrontiSS = new Integer(0), nroConfrontiCrescenteSS = new Integer(0), nroConfrontiDecrescenteSS = new Integer(0);
		Integer nroConfrontiIS = new Integer(0), nroConfrontiCrescenteIS = new Integer(0), nroConfrontiDecrescenteIS = new Integer(0);
		Integer nroConfrontiSH = new Integer(0), nroConfrontiCrescenteSH = new Integer(0), nroConfrontiDecrescenteSH = new Integer(0);
		Integer nroConfrontiQS = new Integer(0), nroConfrontiCrescenteQS = new Integer(0), nroConfrontiDecrescenteQS = new Integer(0);
		Integer nroConfrontiMS = new Integer(0), nroConfrontiCrescenteMS = new Integer(0), nroConfrontiDecrescenteMS = new Integer(0);
		...
		try {
			...
			for(Integer i = new Integer( step ); i <= maxDim; i += step) {
				...
				System.out.print(": " + nroConfrontiBS + " confronti per ottenere (BubbleSort) ");
				stampaArray(A);
				inizializzaArrayCasuale(A, MAX);
				nroConfrontiSS=SelectionSort.sort(A);
				System.out.print(": " + nroConfrontiSS + " confronti per ottenere (SelectionSort) ");
				stampaArray(A);
				inizializzaArrayCasuale(A, MAX);
				nroConfrontiIS=InsertionSort.sort(A);
				System.out.print(": " + nroConfrontiIS + " confronti per ottenere (InvertionSort) ");
				stampaArray(A);
				inizializzaArrayCasuale(A, MAX);
				nroConfrontiSH=ShellSort.sort(A);
				System.out.print(": " + nroConfrontiSH + " confronti per ottenere (ShellSort) ");
				stampaArray(A);
				inizializzaArrayCasuale(A, MAX);
				nroConfrontiQS=QuickSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiQS + " confronti per ottenere (QuickSort) ");
				stampaArray(A);
				inizializzaArrayCasuale(A, MAX);
				nroConfrontiMS=MergeSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiMS + " confronti per ottenere (MergeSort) ");
				stampaArray(A);
				System.out.println("");
				...
				System.out.print(": " + nroConfrontiCrescenteBS + " confronti per ottenere (BubbleSort) ");
				stampaArray(A);
				inizializzaArrayCrescente(A);
				nroConfrontiCrescenteSS=SelectionSort.sort(A);
				System.out.print(": " + nroConfrontiCrescenteSS + " confronti per ottenere (SelectionSort) ");
				stampaArray(A);
				inizializzaArrayCrescente(A);
				nroConfrontiCrescenteIS=InsertionSort.sort(A);
				System.out.print(": " + nroConfrontiCrescenteIS + " confronti per ottenere (InvertionSort) ");
				stampaArray(A);
				inizializzaArrayCrescente(A);
				nroConfrontiCrescenteSH=ShellSort.sort(A);
				System.out.print(": " + nroConfrontiCrescenteSH + " confronti per ottenere (ShellSort) ");
				stampaArray(A);
				inizializzaArrayCrescente(A);
				nroConfrontiCrescenteQS=QuickSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiCrescenteQS + " confronti per ottenere (QuickSort) ");
				stampaArray(A);
				inizializzaArrayCrescente(A);
				nroConfrontiCrescenteMS=MergeSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiCrescenteMS + " confronti per ottenere (MergeSort) ");
				stampaArray(A);
				System.out.println("");
				...
				System.out.print(": " + nroConfrontiDecrescenteBS + " confronti per ottenere (BubbleSort) ");
				stampaArray(A);
				inizializzaArrayDecrescente(A);
				nroConfrontiDecrescenteSS=SelectionSort.sort(A);
				System.out.print(": " + nroConfrontiDecrescenteSS + " confronti per ottenere (SelectionSort) ");
				stampaArray(A);
				inizializzaArrayDecrescente(A);
				nroConfrontiDecrescenteIS=InsertionSort.sort(A);
				System.out.print(": " + nroConfrontiDecrescenteIS + " confronti per ottenere (InvertionSort) ");
				stampaArray(A);
				inizializzaArrayDecrescente(A);
				nroConfrontiDecrescenteSH=ShellSort.sort(A);
				System.out.print(": " + nroConfrontiDecrescenteSH + " confronti per ottenere (ShellSort) ");
				stampaArray(A);
				inizializzaArrayDecrescente(A);
				nroConfrontiDecrescenteQS=QuickSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiDecrescenteQS + " confronti per ottenere (QuickSort) ");
				stampaArray(A);
				inizializzaArrayDecrescente(A);
				nroConfrontiDecrescenteMS=MergeSort.sort(A, 0, A.length-1);
				System.out.print(": " + nroConfrontiDecrescenteMS + " confronti per ottenere (MergeSort) ");
				stampaArray(A);
				System.out.println("");
				
				Output.println(i +","+ nroConfrontiBS +","+ nroConfrontiCrescenteBS +","+ nroConfrontiDecrescenteBS
						+","+ nroConfrontiSS +","+ nroConfrontiCrescenteSS +","+ nroConfrontiDecrescenteSS
						+","+ nroConfrontiIS +","+ nroConfrontiCrescenteIS +","+ nroConfrontiDecrescenteIS
						+","+ nroConfrontiSH +","+ nroConfrontiCrescenteSH +","+ nroConfrontiDecrescenteSH
						+","+ nroConfrontiQS +","+ nroConfrontiCrescenteQS +","+ nroConfrontiDecrescenteQS
