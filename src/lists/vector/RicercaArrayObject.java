...
public class RicercaArrayObject {
	 ...
	 */
	static boolean sequentialSearch(Comparable<Object> A[], int x,
			int numeroConfronti[]) {
		numeroConfronti[0] = 0;
	 ...
	 */
	static boolean binarySearch(Comparable<Object> A[], int x,
			int numeroConfronti[]) {
		numeroConfronti[0] = 0;
		boolean trovato = false;
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (binarySearch(A, elemento, numeroConfronti))
				System.out.println(elemento + " trovato con "
						+ numeroConfronti[0] + " confronti");
			else
				System.out.println(elemento + " NON trovato con "
						+ numeroConfronti[0] + " confronti");
		} catch (IOException e) {
