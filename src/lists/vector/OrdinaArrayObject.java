...
public class OrdinaArrayObject {
	...
	public static void main(String args[]) {
		...
		Persona A[] = { new Persona("Malerba Donato"),
				...
				new Persona("Plantamura Paola"), new Persona("Malerba Donato") };
		stampaArray(A);
		System.out.println("Ordinamento");
		BubbleSort.sort(A);
		stampaArray(A);

		Integer B[] = { new Integer(3), new Integer(5), new Integer(12),
				new Integer(3), new Integer(3), new Integer(5), new Integer(7),
				new Integer(1) };
		stampaArray(B);
		System.out.println("Ordinamento");
		BubbleSort.sort(B);
