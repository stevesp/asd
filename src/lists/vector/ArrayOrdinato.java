...
public class ArrayOrdinato implements Dizionario {
	 ...
	 * è scelto arbitrariamente tra quelli con chiave <code>k</code>.
	...
	public void delete(Comparable<Object> k) {
		...
		while (i<j) {
			...
			if (k.compareTo(S[m].chiave)==0) {
				...
				if(k.compareTo(S[m].chiave) < 0) // ricerca in partizione a sinistra di m
					j=m;
				else // ricerca in partizione a destra di m
					i=m+1;
		}
	...
	public static void main(String[] args) {
		...
		while(!exit){
			...
			switch (k) {
				case 1: System.out.println("|| Inserimento dell'elemento ||");
						...
						break;
				case 2: System.out.println("|| Eliminazione dell'elemento ||");
						System.out.println("Numero: ");
						numero = Keyboard.readString();
						try {
						...
						System.out.println("Done");
						break;
				case 3: System.out.println("|| Ricerca di un elemento ||");
						System.out.println("Numero: ");
						numero = Keyboard.readString();
						try {
				...
				case 4: System.out.println("Bye!");
						exit=true;
						break;
				default: System.out.println("Cosa vuoi fare?");
						System.out.println("1. Inserire un elemento");
						System.out.println("2. Eliminare un elemento");
						System.out.println("3. Cercare un elemento");
						System.out.println("4. Esci");
