...
public class ArrayDoubling implements Dizionario {
	...
	/*
	 * Sia i la posizione dell'elemento di S con chiave k, tale elemento può
	 * essere sovrascritto con l'elemento di S in posizione (n-1), decrementando
	 * poi n di uno ed eventualmente (se n<S.length/4) dimezzando l'array.
	 * Sollevare la eccezione EccezioneChiaveNonValida se la chiave k non
	 * appartien ad S
	 */
	@Override
	...
	/*
	 * Previo eventuale raddoppiamento dell'array, ogni nuovo elemento viene
	 * inserito nella cella di indice n, e poi si incrementa n di uno.
	 */
	@Override
