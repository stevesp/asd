...
public class Test {
	...
	public static void main(String[] args) {
		...
		blocchi[0] = new Block(new Point2D(10, 200), new Point2D(50, 180),
				TypeC.GRAPHICS);

		blocchi[1] = new Block(new Point2D(10, 179), new Point2D(50, 150),
				TypeC.TEXT);

		blocchi[2] = new Block(new Point2D(10, 149), new Point2D(30, 100),
				TypeC.TEXT);

		blocchi[3] = new Block(new Point2D(10, 99), new Point2D(30, 20),
				TypeC.TEXT);

		blocchi[4] = new Block(new Point2D(35, 99), new Point2D(50, 20),
				TypeC.GRAPHICS);

		blocchi[5] = new Block(new Point2D(31, 149), new Point2D(50, 100),
				TypeC.GRAPHICS);
