...
public class Test {
	...
	public static void main(String[] args) {
		...
		ListaElettorale[] liste = new ListaElettorale[] {
				new ListaElettorale("W l'Italia", new ArrayList<String>()),
				new ListaElettorale("In medio stat virtus",
						new ArrayList<String>()),
				new ListaElettorale("Ecumenismo a sinistra",
						new ArrayList<String>()),
