...
public class OrologioDaPolso {
	...
	public void start() {
		...
		while ((oStart != o) || (mStart != m)) {
			...
			if (m.getEvent() != null)
				System.out.println(o.getName()+":"+m.getName()+" "+m.getEvent());
		...
		if (mStart.getEvent() != null)
			System.out.println(oStart.getName()+":"+mStart.getName()+" "+mStart.getEvent());
	}
	
	public boolean equals(OrologioDaPolso orologio){
		return (this.ore.equals(orologio.ore) && 
				this.minuti.equals(orologio.minuti));
	}
}
