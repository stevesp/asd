...
public class TestFabio {
	...
	public static void main(String[] args) {
		...
		Collaborazioni collaborazioni1 = initCollaborazione(autoriOrig, 20, 6); // Autori,
																				// Articoli,
																				// Collaboratori
		...
		Collaborazioni collaborazioni2 = initCollaborazione(autoriOrig, 1, 3); // Autori,
																				// Articoli,
																				// Collaboratori
		...
		if (contained)
			System.out
					.println("La collaborazione 1 contiene la collaborazione 2.");
		else {
			System.out
					.println("La collaborazione 1 NON contiene la collaborazione 2.");
		}
		...
		for (Autore autore1 : autoriOrig) {
			...
			System.out.println("----------------------");
			System.out.println("Collaboratori di : " + autore1.getNome() + " "
					+ autore1.getCognome());
			System.out.println("----------------------");
		...
		System.out.println("Numero di autori: " + collaborazioni1.numAutori()); // Stampa
																				// il
																				// numero
																				// di
																				// autori
		...
		System.out.println("Numero di collaborazioni "
				+ collaborazioni1.numCollaborazioni()); // Stampa il numero di
														// collaborazioni
		...
		// Chiede di stampare gli autori della pubblicazione 'Articolo
		// sul...versione 0' del 1980
		Autori autoriLavoro = collaborazioni1.autori(
				"Articolo sul divertentismo negli anni 90 versione 0", 1980);

		System.out
				.println("Autori della pubblicazione: 'Articolo sul divertentismo negli anni 90 versione 0'");
	...
	private static List<Autore> initAutori() {
		...
		/*
		 * Stampa tutti gli autori for(Autore aut : autoriOrig) {
	...
	private static Collaborazioni initCollaborazione(List<Autore> autori,
			int numArticoli, int maxCollaboratori) {
