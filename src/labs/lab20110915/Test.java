...
public class Test {
	...
	public static void main(String[] args) {
		...
		Autore dona = new Autore(new String("Donato"), new String("Malerba"),
				new String("LACAM"));
		Autore nico = new Autore(new String("Nicola"), new String("Di Mauro"),
				new String("LACAM"));
		Autore peppe = new Autore(new String("Giuseppe"),
				new String("Visaggio"), new String("SERLAB"));
		Autore ni = new Autore(new String("Nicola"), new String("Fanizzi"),
				new String("LACAM"));
		Autore fa = new Autore(new String("Fabio"), new String("Fumarola"),
				new String("LACAM"));
		Autore giovi = new Autore(new String("Giovanna"), new String(
				"Castellano"), new String("LACAM"));
		Autore nicola = new Autore(new String("Pasquale"), new String(
				"Ardimento"), new String("SERLAB"));
		Autore gio = new Autore(new String("Giovanni"), new String("Dimauro"),
				new String("SERLAB"));
